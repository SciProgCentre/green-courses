# Оформление электронного отчета в рабочей тетради Jupyter Notebook
...
Пример как выглядят элементы тетради можно посмотреть [здесь]() и скачать [здесь](). Что бы открыть файлы смотрите разделы [Установка]() и [Запуск Python]().
